    ...
    <div class="space-y-8">
        ...
        <div>
            ...
            <nav class="mt-4 space-y-1">
                ...
                <a href="#" class="group flex items-center gap-3 rounded-lg border-l-4 {{ $active === 'security' ? 'border-blue-600 bg-blue-50 text-blue-700' : 'border-transparent text-slate-600 hover:bg-slate-50 hover:text-slate-900' }} px-4 py-3 text-sm font-medium transition">
                ...
                <a href="#" class="group flex items-center gap-3 rounded-lg border-l-4 {{ $active === 'addresses' ? 'border-blue-600 bg-blue-50 text-blue-700' : 'border-transparent text-slate-600 hover:bg-slate-50 hover:text-slate-900' }} px-4 py-3 text-sm font-medium transition">
                ...
                <a href="#" class="group flex items-center gap-3 rounded-lg border-l-4 {{ $active === 'payment' ? 'border-blue-600 bg-blue-50 text-blue-700' : 'border-transparent text-slate-600 hover:bg-slate-50 hover:text-slate-900' }} px-4 py-3 text-sm font-medium transition">
                 ...
                 <a href="#" class="group flex items-center gap-3 rounded-lg border-l-4 border-transparent px-4 py-3 text-sm font-medium text-red-600 transition hover:bg-red-50 hover:text-red-700">
